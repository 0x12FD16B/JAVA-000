...
public class HttpInboundServer {
    ...
    public HttpInboundServer(int port, List<String> proxyServers, List<HttpRequestFilter> filters, HttpEndpointRouter httpEndpointRouter) {
        this.port = port;
    ...
    public void run() throws Exception {
        ...
        try {
            ...
            b.group(bossGroup, workerGroup).channel(NioServerSocketChannel.class)
                    .handler(new LoggingHandler(LogLevel.INFO)).childHandler(new HttpInboundInitializer(this.proxyServers, filters, httpEndpointRouter));
